...
function getResults()
{
    ...
    for (var i = 0; i < obj.results.length; i++)
    {
        ...
        EntryBodyElement = document.createElement("div")
        ImageElement = document.createElement("img")
        IconElement = getIcon(obj.results[i].feedUrl)
...
function getIcon(_FeedUrl)
{
    ...
    var Icon =
    `
        <svg onclick="setFavorite(this, '` + _FeedUrl + `')" fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
