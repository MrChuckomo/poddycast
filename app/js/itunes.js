...
function getIcon(_PodcastInfos)
{
    var Icon =
    `
        <svg onclick="setFavorite(this, '`+_PodcastInfos.artistName.replace(/([\"\'])/g,'\\')+`', '`+_PodcastInfos.collectionName.replace(/([\"\'])/g,'\\')+`', '`+_PodcastInfos.artworkUrl30+`', '`+_PodcastInfos.artworkUrl60+`', '`+_PodcastInfos.artworkUrl100+`', '`+_PodcastInfos.feedUrl+`')" fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
